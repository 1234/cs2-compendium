...
| Van smoke | Closes off van position during B site takes |

### Must-know flashes

| Name | Purpose |
|---|---|
| Palace pop flash | Blinds defenders as you push out of palace toward A |
| Short flash (B) | Blind B short before entering site from apps |

### Must-know molotovs

| Name | Purpose |
|---|---|
| B site molotov | Forces defenders off default plant spot |
| Jungle molotov | Clears jungle angle during A retake |
...
Banana control is the foundation of every T-side round on Inferno.
You cannot play T-side effectively without the banana smokes.
...
| Name | Purpose |
|---|---|
| Short flash (A) | Blind defenders as you push out of short toward A |
| Banana flash | Blind banana at top before pushing through |
...
Top banana → Lower banana → Arch → Moto → CT → Coffins → Sandbags molly → Car molly
...
| Name | Purpose |
|---|---|
| B default molotov | Forces defender off default B plant position |
| Pit molotov | Clears pit during A retakes |

### Learning order

Xbox → Long doors → B doors → CT cross → Long flash → B tunnel flash
...
| Name | Purpose |
|---|---|
| Squeaky door molotov | Forces defenders off the squeaky door position |
| CT area molotov | Clears CT spawn area during upper site take |
| Ramp molotov | Forces players off ramp angle |

### Learning order

Mini/Main smoke → Heaven smoke → Hut smoke → Squeaky molotov → Ramp smoke → Outside smoke
...
| B-site connector smoke | Cuts connector rotation during B execute |

### Must-know flashes

| Name | Purpose |
|---|---|
| A site flash | Blind defenders as you push onto A |
| Canal flash | Blind B position before entering from water |

### Must-know molotovs

| Name | Purpose |
|---|---|
| B default molotov | Forces defender off default plant spot |
| A pillar molotov | Clears pillar on A during execute |

### Learning order

Mid smoke → Canal smoke → E-box smoke → A-site CT → Canal flash → B molotov

---

## Ancient

Mid control (Red/House area) is the core of T-side Ancient. Without it,
both sites are nearly impossible to execute onto.
...
| Donut smoke | Covers donut area during B push |

### Must-know flashes

| Name | Purpose |
|---|---|
| A ramp flash | Blinds defenders at top of A ramp |
| B flash | Blinds B site entry from cave |

### Must-know molotovs

| Name | Purpose |
|---|---|
| A default molotov | Forces off default plant on A |
| Cave molotov | Clears cave corner during B push |

### Learning order

Mid/Red smoke → A main smoke → A CT smoke → B cave smoke → A ramp flash → A default molotov
...
| Name | Purpose |
|---|---|
| Short flash | Blinds CT at top of short |
| A site flash | Blinds defenders as you push onto A |
...
Short smoke → Connector smoke → Bathrooms molotov → Long A smoke → Short flash → Water smoke

---

## Monthly utility schedule

Integrated into the main monthly plan in [README.md](../README.md).
